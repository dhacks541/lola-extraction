function [lon,lat,rad,et,met,flg,scrad,time,offndr,pw,en,rnge,rflct,...
  ...
  earth_range,earth_pulse,local_soltim, subseconds] = readRDRfunc(RDRin,ispots,skip)

% good flag:
% 0 = good by auto-editor and manual
% 1 = good by auto-editor, but bad by manual
% 64 = bad by auto-editor, but recovered as good by manual
% 89 = no return signal?
%
% pw in nanosec
% en and xenrg in mJ
