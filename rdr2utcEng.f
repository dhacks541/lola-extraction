...
c gfortran -ffixed-line-length-none -O rdr2utcEng.f unsigned.o kzext2.o spicelib.a -static-libgfortran -o rdr2utcEng
...
c  sum the noise counts for 28 records
	if(head)
     ...
     & ,', gain1, gain2, gain3, gain4, gain5,    sclon,    sclat, UTC'
c first record
	MET=rdr(1)
...
c	format(i10,",",i10,f0.6,",",9p,f10.1,",",i3,",",0p,2(f8.3,","),f8.2,",",f8.2,",",5(i7,","),10(f6.2,","),f9.4,",",f9.
	if (flagu) then
	 tt=tdtold+tickold
	 call et2utc (tt,'isod',5,utc)
	 write(*,1202) utc
